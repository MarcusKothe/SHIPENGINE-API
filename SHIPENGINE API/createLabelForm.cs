...
namespace SHIPENGINE_API
{
    public partial class createLabelForm : Form
    {
        ...
        private void createLabelForm_Load(object sender, EventArgs e)
        {
            ...
            ship_date_TimePicker.MinDate = DateTime.Today;

            ship_date_TimePicker.Format = DateTimePickerFormat.Custom;
            ship_date_TimePicker.CustomFormat = "dd-MM-yyyy";
        ...
        public void createLabelbutton_Click(object sender, EventArgs e)
        {
            //Set color and font
            ...
            try
            {
                ...
                string shipToName = ship_To_Name_TextBox.Text;
                string ship_date = this.ship_date_TextBox.Text;
        ...
        private void shipDateTimePicker_ValueChanged(object sender, EventArgs e)
        {
            ...
            DateTime shipDate = ship_date_TimePicker.Value;
            ship_date_TextBox.Text = shipDate.ToString();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (var reader = new StringReader(responseBodyText))
                {
                    ...
                    responseBodyrichTextbox.Text = ratesResponse;
                }
